...
```{r report_pa_sub_lognormald, fig.height=7, fig.width=9, dpi=600, results='asis'}
#svg("plot.svg", width = 6, height = 8)
...
conditional_spaghetti(
  ...
  group_var = 'coupleID',
  plot_full_range = TRUE,
  x_label = 'Daily plan-related pushing (centered)',
...
```{r ddd, fig.height=7, fig.width=7, dpi=600, results='asis'}

#svg("plot2.svg", width = 7, height = 8)
...
plot(p_direction(draws_df, null = 1))
