...
```{r report_pa_sub_lognormal, results='asis', fig.width=8, fig.height=6, dpi=300}
...
marginaleffects::avg_slopes(
  pa_sub, 
  variables = c('persuasion_self_cw',
              'persuasion_partner_cw',
              'pressure_self_cw',
              'pressure_partner_cw',
              'pushing_self_cw',
...
```{r report_pa_sub_separate_inactive, results='asis', fig.width=8, fig.height=6, dpi=300}
...
```{r report_pa_sub_separate_active, results='asis', fig.width=8, fig.height=6, dpi=300}
...
```{r pa_sub_active_model_marginaleffects}
...
#```{r pa_obj_log_model_marginaleffects}

marginaleffects::avg_predictions(pa_obj_log)
marginaleffects::avg_slopes(
  pa_obj_log, 
  variables = c('persuasion_self_cw',
              'persuasion_partner_cw',
...
marginaleffects::avg_slopes(
  mood_gauss, 
  variables = c('pushing_partner_cw')
  )
...
only plotting 10 random participant's random effects to make the plot readable. 
...
marginaleffects::avg_slopes(
  reactance_ordinal, 
  variables = c('persuasion_self_cw', 'pressure_self_cw')
  )
