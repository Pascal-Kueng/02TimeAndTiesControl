...
# Create the vertical density plots with enhanced styling and internal legend
ggplot(plot_data_filtered, aes(x = value, y = slope_type, height = after_stat(density))) +
