...
```{r report_pa_sub_lognormal, results='asis', fig.width=8, fig.height=7, dpi=300, fig.showtext=TRUE}
...
```{r report_pa_sub_lognormald, fig.height=11, fig.width=12, dpi=600, fig.showtext=TRUE, results='asis'}
...
conds_eff <- conditional_spaghetti(
  ...
  y_limits = c(0, 100),
  y_label = 'MVPA',
  y_labels = c('Probability of MVPA > 0', 'Expected MVPA When Active', 'Overall Expected MVPA'),
...
```{r fig.height=11, fig.width = 12, dpi=1200, fig.showtext=TRUE}
...
```{r report_mood_gauss, results='asis', fig.width=8, fig.height=6, dpi=300, fig.showtext=TRUE}
...
```{r report_reactance_ordinal, results='asis', fig.width=8, fig.height=6, dpi=300, fig.showtext=TRUE}
...
```{r report_is_reactance, results='asis', fig.width=8, fig.height=6, dpi=300, fig.showtext=TRUE}
