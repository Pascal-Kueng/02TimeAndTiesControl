...
```{r report_pa_sub_lognormal, results='asis', fig.width=8, fig.height=7, dpi=300, cache=TRUE, cache.extra=pa_sub_digest}
...
```{r report_pa_sub_lognormald, fig.height=11, fig.width=12, dpi=600, results='asis'}
...
```{r pa_sub_lognormal_marginaleffects, cache=TRUE, cache.extra=pa_sub_digest}
...
priorsense::powerscale_sensitivity(pa_obj_log, variable = vars)
priorsense::powerscale_plot_dens(pa_obj_log, variable = vars)
priorsense::powerscale_plot_ecdf(pa_obj_log, variable = vars)
priorsense::powerscale_plot_quantities(pa_obj_log, variable = vars)

```



```{r report_pa_obj_log_g, results='asis', cache=TRUE, cache.extra=pa_obj_log_digest}
...
priorsense::powerscale_sensitivity(mood_gauss, variable = vars)
priorsense::powerscale_plot_dens(mood_gauss, variable = vars)
priorsense::powerscale_plot_ecdf(mood_gauss, variable = vars)
priorsense::powerscale_plot_quantities(mood_gauss, variable = vars)


```

```{r report_mood_gauss, results='asis', fig.width=8, fig.height=6, dpi=300, cache=TRUE, cache.extra=mood_gauss_digest}
...
```{r mood_gauss_marginaleffects, cache=TRUE, cache.extra=mood_gauss_digest}
...
priorsense::powerscale_sensitivity(reactance_ordinal, variable = vars)
priorsense::powerscale_plot_dens(reactance_ordinal, variable = vars)
priorsense::powerscale_plot_ecdf(reactance_ordinal, variable = vars)
priorsense::powerscale_plot_quantities(reactance_ordinal, variable = vars)


```

```{r report_reactance_ordinal, results='asis', fig.width=8, fig.height=6, dpi=300, cache=TRUE, cache.extra=reactance_ordinal_digest}
...
```{r reactance_ordinal_marginaleffects, cache=TRUE, cache.extra=reactance_ordinal_digest}
...
priorsense::powerscale_sensitivity(is_reactance, variable = vars)
priorsense::powerscale_plot_dens(is_reactance, variable = vars)
priorsense::powerscale_plot_ecdf(is_reactance, variable = vars)
priorsense::powerscale_plot_quantities(is_reactance, variable = vars)

```

```{r report_is_reactance, results='asis', fig.width=8, fig.height=6, dpi=300, cache=TRUE, cache.extra=is_reactance_digest}
...
```{r is_reactance_marginaleffects, cache=TRUE, cache.extra=is_reactance_digest}
...
```{r report_sidebyside, results = 'asis', cache=TRUE, cache.extra=is_reactance_digest}
