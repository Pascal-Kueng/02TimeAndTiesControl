...
pa_sub <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path(working_directory, "models_cache_final", "pa_sub")
)
...
pa_obj_log <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path(working_directory, "models_cache_final", "pa_obj_log")
)
...
mood <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path(working_directory, "models_cache_final", "mood")
)
...
reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path(working_directory, "models_cache_final", "reactance")
)
...
reactance_ordinal <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path(working_directory, "models_cache_final", "reactance_ordinal")
)
...
is_reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path(working_directory, "models_cache_final", "is_reactance")
)
...
export_xlsx(
  ...
  file.path(working_directory, "OutputFinal", "AllModels.xlsx"), 
  merge_option = 'both', 
