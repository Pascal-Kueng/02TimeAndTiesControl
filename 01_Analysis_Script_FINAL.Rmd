...
export_xlsx(df_sample_summary,
            file.path('OutputFinal', 'SampleDescription.xlsx'),
            merge_option = 'both',
            rows_to_pack = packing_sample,
...
openxlsx::write.xlsx(
  all_descriptives, 
  file.path('OutputFinal', 'DescriptivesAll.xlsx')
)
...
openxlsx::write.xlsx(
  main_cors, 
  file.path('OutputFinal', 'Correlations.xlsx')
)
...
pa_sub <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_final", "pa_sub")
)
...
pa_obj_log <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_final", "pa_obj_log")
)
...
mood <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_final", "mood")
)
...
reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_final", "reactance")
)
...
reactance_ordinal <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_final", "reactance_ordinal")
)
...
is_reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_final", "is_reactance")
)
...
export_xlsx(
  ...
  file.path("OutputFinal", "AllModels.xlsx"), 
  merge_option = 'both', 
