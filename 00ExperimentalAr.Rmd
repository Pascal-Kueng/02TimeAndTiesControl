...
prior1 <- c(
  brms::set_prior("normal(0, 2.5)", class = "b")
  #, brms::set_prior("normal(2, 1)", class = "Intercept", lb=0, ub=5)
  , brms::set_prior("normal(2.5, 1)", class = "Intercept", coef = '1') # range of the
  , brms::set_prior("normal(3.5, 2)", class = "Intercept", coef = '2') # range of
  , brms::set_prior("normal(5, 2)", class = "Intercept", coef = '3') # range oftheoutcome
  , brms::set_prior("normal(8, 3)", class = "Intercept", coef = '4') # range
  , brms::set_prior("normal(12, 4)", class = "Intercept", coef = '5') # rangeoftheoutcomescale
