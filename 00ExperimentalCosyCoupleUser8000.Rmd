...
```{r pa_sub, results='hide', message=FALSE}
...
formula <- bf(
  ...
  , autocor = ~ cosy(time = day, gr = coupleID:userID)
  #, autocor = ~ ar(time = day, gr = coupleID:userID)
  #, autocor = ~ ma(time = day, gr = coupleID:userID)
  #, autocor = ~ arma(time = day, gr = coupleID:userID)
  #, autocor = ~ unstr(time = day, gr = coupleID:userID)
)
...
prior1 <- c(
  ...
  #brms::set_prior("normal(0, 0.5)", class = "ar", lb = -1, ub = 1), # Autocorrelation prior
  #brms::set_prior("normal(0, 0.5)", class = "ma", lb = -1, ub = 1), # moving average prior
  brms::set_prior("normal(0, 0.5)", class = "cosy", lb = -1, ub = 1), # compound symmetry prior
...
pa_sub <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "pa_sub_hu_cosycoupleuser")
)
...
pa_obj_log <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "pa_obj_lognormal_cosycoupleuser")
)
...
```{r mood, results='hide', results='hide', message=FALSE}
...
mood <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "mood_skew_cosycoupleuser")
)
...
reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "reactance_hu_cosycoupleuser")
  #, file_refit = 'always'
)
...
reactance_ordinal <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "reactance_ordinal_noar_cosycoupleuser")
  #, file_refit = 'always'
)
...
is_reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "is_reactance_noar_cosycoupleuser")
  #, file_refit = 'always'
)
