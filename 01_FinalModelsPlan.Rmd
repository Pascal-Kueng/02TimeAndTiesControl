...
pa_sub <- my_brm(
  ...
  cores = 4,
  seed = 42,
  file = file.path("models_cache_brms", paste0("pa_sub_hu_lognormal_finalwithplan_", suffix))
  #, file_refit = 'always'
)
...
pa_obj_log <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", paste0("pa_obj_log_gaussian_finalwithplan_", suffix))
)
...
mood_gauss <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", paste0("mood_gauss_finalwithplan_", suffix))
)
...
reactance_ordinal <- my_brm(
  ...
  cores = 4,
  seed = 7777
  , file = file.path("models_cache_brms", paste0("reactance_ordinal_finalwithplan_", suffix))
)
...
is_reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", paste0("is_reactance_finalwithplan_", suffix))
  #, file_refit = 'always'
)
...
export_xlsx(
  ...
  file.path("Output", "AllModelsFinalWithPlans.xlsx"), 
  merge_option = 'header', 
