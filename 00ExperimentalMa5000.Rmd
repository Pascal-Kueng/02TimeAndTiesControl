...
pa_sub <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "pa_sub_hu_ma5000")
)
...
pa_obj_log <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "pa_obj_lognormal_ma5000")
)
...
mood <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "mood_skew_ma5000")
)
...
reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "reactance_hu_ma5000")
  #, file_refit = 'always'
)
...
reactance_ordinal <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "reactance_ordinal_noar_ma5000")
  #, file_refit = 'always'
)
...
is_reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "is_reactance_noar_ma5000")
  #, file_refit = 'always'
)
