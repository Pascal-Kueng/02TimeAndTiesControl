...
persuasion_pa_sub_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "persuasion_pa_sub_ind")
)
...
persuasion_pa_sub_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_persuasion_pa_sub_apim")
)
...
persuasion_pa_obj_log_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_persuasion_pa_obj_log_ind")
)
...
persuasion_pa_obj_log_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_persuasion_pa_obj_log_apim")
)
...
persuasion_aff_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_persuasion_aff_ind")
)
...
persuasion_aff_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_persuasion_aff_apim")
)
...
persuasion_anticipAff_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_persuasion_anticipAff_ind")
)
...
persuasion_anticipAff_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_persuasion_anticipAff_apim")
)
...
persuasion_reactance_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_persuasion_reactance_ind")
)
...
persuasion_reactance_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_persuasion_reactance_apim")
)
...
pressure_pa_sub_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pressure_pa_sub_ind")
)
...
pressure_pa_sub_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pressure_pa_sub_apim")
)
...
pressure_pa_obj_log_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pressure_pa_obj_log_ind")
)
...
pressure_pa_obj_log_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pressure_pa_obj_log_apim")
)
...
pressure_aff_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pressure_aff_ind")
)
...
pressure_aff_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pressure_aff_apim")
)
...
pressure_anticipAff_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pressure_anticipAff_ind")
)
...
pressure_anticipAff_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pressure_anticipAff_apim")
)
...
pressure_reactance_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pressure_reactance_ind")
)
...
pressure_reactance_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pressure_reactance_apim")
)
...
pushing_pa_sub_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pushing_pa_sub_ind")
)
...
pushing_pa_sub_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pushing_pa_sub_apim")
)
...
pushing_pa_obj_log_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pushing_pa_obj_log_ind")
)
...
pushing_pa_obj_log_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pushing_pa_obj_log_apim")
)
...
pushing_aff_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pushing_aff_ind")
)
...
pushing_aff_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pushing_aff_apim")
)
...
pushing_anticipAff_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pushing_anticipAff_ind")
)
...
pushing_anticipAff_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pushing_anticipAff_apim")
)
...
pushing_reactance_ind <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pushing_reactance_ind")
)
...
pushing_reactance_apim <- brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "as_preregistered_pushing_reactance_apim")
)
