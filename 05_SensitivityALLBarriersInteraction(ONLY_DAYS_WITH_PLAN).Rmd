...
suffix = paste0('_final_with_plan_and_barriers_ALL_INTERACTION', as.character(iterations))
...
rows_to_pack_ordinal <- list(
  ...
  "Between-Person Effects" = c(14+5,20+5),
  "Interactions" = c(21+5, 38+5),
  "Random Effects" = c(39+5, 53+5), 
  "Additional Parameters" = c(54+5,54+6)
  )
...
formula <- bf(
  pa_sub ~ 
    ...
    barriers_self_cw + barriers_partner_cw + 
    facilitators_self_cw + facilitators_partner_cw +
    ...
    barriers_self_cb + barriers_partner_cb +
    facilitators_self_cb + facilitators_partner_cb +
    day + 
