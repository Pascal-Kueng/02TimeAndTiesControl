...
cors <- wbCorr(
  df_double[,c('ss_psc_more', 'persuasion_partner')], 
  df_double$coupleID, 
  method = 'spearman')
...
cors <- wbCorr(
  df_double[,c('ss_nsc_more', 'pressure_partner')], 
  df_double$coupleID, 
  method = 'spearman')
...
cors <- wbCorr(
  df_double[,c('ss_push_plan', 'pushing_partner')], 
  df_double$coupleID, 
  method = 'spearman')
...
reliability_psc <- multilevelTools::omegaSEM(
  c('ss_psc_more', 'persuasion_partner'),
  'coupleID',
  data = df_double
)

reliability_nsc <- multilevelTools::omegaSEM(
  c('ss_nsc_more', 'pressure_partner'),
  'coupleID',
  data = df_double
)

reliability_pushing <- multilevelTools::omegaSEM(
  c('ss_push_plan', 'pushing_partner'),
  'coupleID',
  data = df_double
)
