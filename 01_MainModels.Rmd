...
cors <- wbCorr(
  df_double[,c('exerted_persuasion_self', 'persuasion_partner')], 
  df_double$coupleID, 
  method = 'spearman')
...
cors <- wbCorr(
  df_double[,c('exerted_pressure_self', 'pressure_partner')], 
  df_double$coupleID, 
  method = 'spearman')
...
cors <- wbCorr(
  df_double[,c('exerted_pushing_self', 'pushing_partner')], 
  df_double$coupleID, 
  method = 'spearman')
...
reliability_psc <- multilevelTools::omegaSEM(
  c('exerted_persuasion_self', 'persuasion_partner'),
  'coupleID',
  data = df_double
)
...
reliability_nsc <- multilevelTools::omegaSEM(
  c('exerted_pressure_self', 'pressure_partner'),
  'coupleID',
  data = df_double
)
...
reliability_pushing <- multilevelTools::omegaSEM(
  c('exerted_pushing_self', 'pushing_partner'),
  'coupleID',
  data = df_double
)
