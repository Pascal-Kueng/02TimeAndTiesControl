...
conditional_spaghettsi_plots = FALSE
...
suffix = paste0('_MainModels', as.character(iterations))
...
formula <- bf(
  received_persuasion_self ~ 
    day +
    exerted_persuasion_partner_cw + 
    exerted_persuasion_self_cw + 
    exerted_persuasion_partner_cb + 
    exerted_persuasion_self_cb +  
    (1 | coupleID) 
  + (1 + exerted_persuasion_partner_cw + exerted_persuasion_self_cw | coupleID:userID)
)
...
fit <- brm(
  ...
  chains = 4, 
  cores = 4,
  file = 'models_cache_brms/testest'
)
...
cors <- wbCorr(
  df2[,c('exerted_persuasion_self', 'received_persuasion_partner')], 
  df2$coupleID, 
  method = 'spearman')
...
cors <- wbCorr(
  df2[,c('exerted_pressure_self', 'received_pressure_partner')], 
  df2$coupleID, 
  method = 'spearman')
...
cors <- wbCorr(
  df2[,c('exerted_pushing_self', 'received_pushing_partner')], 
  df2$coupleID, 
  method = 'spearman')
...
rows_to_pack <- list(
  ...
  "Random Effects (Level 3 - Couple)" = c(19, 19), 
  "Random Effects (Level 2 - Couple:Person)" = c(20, 26), 
...
rows_to_pack_ordinal <- list(
  ...
  "Random Effects (Level 3 - Couple)" = c(19+5, 19+5), 
  "Random Effects (Level 2 - Couple:Person)" = c(20+5, 26+5), 
...
if (conditional_spaghettsi_plots){
