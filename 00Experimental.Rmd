...
hist(df_double$pa_sub, breaks = 30) 

hist(log(df_double$pa_sub+00000000001), breaks = 30)
...
prior1 <- c(
  ...
  #brms::set_prior("normal(0, 0.1)", class = "ar", lb = -1, ub = 1), # Autocorrelation prior
  #brms::set_prior("normal(0,5)", class = "sderr", lb = 0),
...
prior1 <- c(
  ...
  #brms::set_prior("student_t(3, 0, 10)", class = "sderr", lb = 0),
...
prior1 <- c(
  ...
  brms::set_prior("normal(0, 1.5)", class = "Intercept", dpar = 'hu'), # hurdle part
...
```{r compare react mods}
loo_compare(loo_reactance, loo_reactance_ordinal, loo_is_reactance)
```
