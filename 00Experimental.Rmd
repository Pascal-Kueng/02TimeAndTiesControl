...
formula <- bf(
  ...
  #, autocor = ~ unstr(time = day, gr = coupleID)
...
prior1 <- c(
  brms::set_prior("normal(0, 2.5)", class = "b", dpar = "mu1"),
    brms::set_prior("normal(0, 2.5)", class = "b", dpar = "mu2"),

  brms::set_prior("normal(2, 2)", class = "Intercept", dpar = "mu1"), # for day to day MVPA
  brms::set_prior("normal(4, 2)", class = "Intercept", dpar = "mu2"),
  
  brms::set_prior("dirichlet(8,1)", class = "theta"),

  #brms::set_prior("normal(6, 2.5)", class = "Intercept", dpar = 'hu'), # hurdle part
  
  brms::set_prior("normal(0, 2)", class = "sd", group = "coupleID", dpar = "mu1", lb = 0), 
  brms::set_prior("normal(0, 2)", class = "sd", group = "coupleID", dpar = "mu2", lb = 0),  
  ...
  #brms::set_prior("normal(0.1,2)", class = "sderr", lb = 0),
  brms::set_prior("normal(0.1,2)", class = "sigma1", lb = 0),
  brms::set_prior("normal(0.1,2)", class = "sigma2", lb = 0) 
)
...
pa_obj_log <- my_brm(
  ...
  prior = prior1,
  data = df_double, 
  family = brms::mixture(lognormal(), lognormal()),
  #control = list(adapt_delta = 0.95),
  iter = iterations,
  chains = 4,
  cores = 4,
...
prior1 <- c(
  ...
  brms::set_prior("normal(3, 2)", class = "Intercept", lb=0, ub=6), # range of the outcome scale
...
check_brms(reactance, log_pp_check = TRUE)
