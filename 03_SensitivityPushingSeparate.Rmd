...
```{r check_pa_sub_lognormal_pushingonly, cache=TRUE, cache.extra=pa_sub_digest}
check_brms(pa_sub, log_pp_check = TRUE)
DHARMa.check_brms.all(pa_sub, integer = TRUE, outliers_type = 'bootstrap')
```
...
```{r report_pa_sub_lognormal_pushingonly, results='asis', fig.width=8, fig.height=7, dpi=300, cache=TRUE, cache.extra=c(pa_sub_digest, report_function_hash)}
...
```{r report_pa_sub_lognormald_pushingonly, fig.height=11, fig.width=12, dpi=600, results='asis', cache=TRUE, cache.extra=pa_sub_digest}
...
```{r explore_pa_obj_dist_pushingonly}
...
```{r check_pa_obj_log_g_pushingonly, cache=TRUE, cache.extra=pa_obj_log_digest}
check_brms(pa_obj_log, log_pp_check = TRUE)
DHARMa.check_brms.all(pa_obj_log, integer = TRUE, outliers_type = 'bootstrap')
```
...
```{r report_pa_obj_log_g_pushingonly, results='asis', cache=TRUE, cache.extra=c(pa_obj_log_digest, report_function_hash)}
...
```{r explore_aff_dist_pushingonly}
...
```{r check_mood_gauss_pushingonly, cache=TRUE, cache.extra=mood_gauss_digest}
check_brms(mood_gauss, log_pp_check = FALSE)
DHARMa.check_brms.all(mood_gauss, integer = FALSE)
```


```{r report_mood_gauss_pushingonly, results='asis', fig.width=8, fig.height=6, dpi=300, cache=TRUE, cache.extra=c(mood_gauss_digest, report_function_hash)}
...
```{r investigatee_reactance_pushingonly}
...
```{r check_reactance_ordinal_pushingonly, cache=TRUE, cache.extra=reactance_ordinal_digest}
check_brms(reactance_ordinal)
DHARMa.check_brms.all(reactance_ordinal, outliers_type = 'bootstrap')
```
...
```{r report_reactance_ordinal_pushingonly, results='asis', fig.width=8, fig.height=6, dpi=300, cache=TRUE, cache.extra=c(reactance_ordinal_digest, report_function_hash)}
...
```{r check_is_reactance_pushingonly, cache=TRUE, cache.extra=is_reactance_digest}
check_brms(is_reactance)
DHARMa.check_brms.all(is_reactance, integer = FALSE)
```
...
```{r report_is_reactance_pushingonly, results='asis', fig.width=8, fig.height=6, dpi=300, cache=TRUE, cache.extra=c(is_reactance_digest, report_function_hash)}
