...
ggsave('Output/Plots/beautifulplot_raw.svg', p[[1]], width = 12, height = 11, dpi = 900)
rsvg::rsvg_pdf("Output/Plots/beautifulplot_raw.svg", "Output/Plots/beautifulplot_raw.pdf")

knitr::include_graphics('Output/Plots/beautifulplot_raw.pdf')
