...
```{r set_options, message=FALSE, results='hide', echo=FALSE}
...
```{r prepare_datasets, message=FALSE, results='hide', echo=FALSE}
...
```{r pa_sub_lognormal, message=FALSE, results='hide', echo=FALSE}
...
```{r fig.height=11, fig.width = 12, message=FALSE, warning=FALSE, echo=FALSE}
