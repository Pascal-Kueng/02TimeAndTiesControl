...
pa_sub <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "all_covariates_pa_sub")
)
...
pa_obj_log <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "all_covariates_pa_obj_log")
)
...
mood <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "all_covariates_mood")
)
...
reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "all_covariates_reactance")
...
is_reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache", "all_covariates_is_reactance")
