...
### negbinomial
```{r pa_sub_negbinom, results='hide', message=FALSE}
...
pa_sub <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", paste0("pa_sub_hu_negbinom", suffix))
)
...
```{r report_pa_sub_negbinom, results='asis'}
...
### lognormal
```{r pa_sub_lognorm, results='hide', message=FALSE}
...
```{r report_pa_sub_lognorm, results='asis'}
