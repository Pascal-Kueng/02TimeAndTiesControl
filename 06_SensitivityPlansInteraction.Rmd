...
model_rows_fixed <- c(
    ...
    'persuasion_self_cw:plan_self_cw',
    'plan_self_cw:pressure_self_cw',
    'plan_self_cw:pushing_self_cw'
  )
...
model_rows_random <- c(
  ...
  'sd(persuasion_self_cw:plan_self_cw)',
  'sd(plan_self_cw:pressure_self_cw)',
  'sd(plan_self_cw:pushing_self_cw)',
...
rows_to_pack <- list(
  ...
  "Between-Person Effects" = c(11,19),
  "Interactions" = c(20, 25),
  "Random Effects" = c(26, 37), 
  "Additional Parameters" = c(38,38)
  )


rows_to_pack_ordinal <- list(
  "Within-Person Effects" = c(2+5,10+5),
  "Between-Person Effects" = c(11+5,19+5),
  "Interactions" = c(20+5, 25+5),
  "Random Effects" = c(26+5, 37+5), 
  "Additional Parameters" = c(38+5,38+6)
  )
...
formula <- bf(
  pa_sub ~ 
    persuasion_self_cw * plan_self_cw + 
    pressure_self_cw * plan_self_cw + 
    pushing_self_cw * plan_self_cw + 
    
    plan_self_cb + plan_partner_cw + plan_partner_cb +
    ...
    # Random effects
    (1 + persuasion_self_cw * plan_self_cw + 
    pressure_self_cw * plan_self_cw + 
    pushing_self_cw * plan_self_cw + 
  ...
  hu = ~ persuasion_self_cw * plan_self_cw + 
    pressure_self_cw * plan_self_cw + 
    pushing_self_cw * plan_self_cw + 
