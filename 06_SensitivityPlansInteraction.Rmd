...
suffix = paste0('_sensitivity_Plan_INTERACTION', as.character(iterations))
...
model_rows_fixed <- c(
    ...
    # Interactions
    'persuasion_self_cw:plan_selfPlan',
    'plan_selfPlan:pressure_self_cw',
    'plan_selfPlan:pushing_self_cw',
    
    'plan_selfPlan:persuasion_partner_cw', 
    'plan_selfPlan:pressure_partner_cw', 
    'plan_selfPlan:pushing_partner_cw', 
        
    'persuasion_self_cw:plan_partnerPlan',
    'pressure_self_cw:plan_partnerPlan',
    'pushing_self_cw:plan_partnerPlan',
    
    'persuasion_partner_cw:plan_partnerPlan',
    'pressure_partner_cw:plan_partnerPlan', 
    'pushing_partner_cw:plan_partnerPlan'
  )
...
model_rows_random <- c(
  ...
  'sd(persuasion_self_cw:plan_selfPlan)',
  'sd(plan_selfPlan:pressure_self_cw)',
  'sd(plan_selfPlan:pushing_self_cw)',
  'sd(plan_selfPlan:persuasion_partner_cw)', 
  'sd(plan_selfPlan:pressure_partner_cw)', 
  'sd(plan_selfPlan:pushing_partner_cw)',
...
rows_to_pack <- list(
  ...
  "Interactions" = c(19, 30),
  "Random Effects" = c(31, 40), 
  "Additional Parameters" = c(41,41)
  )
...
rows_to_pack_ordinal <- list(
  ...
  "Interactions" = c(19+5, 30+5),
  "Random Effects" = c(31+5, 40+5), 
  "Additional Parameters" = c(41+5,41+6)
  )
...
formula <- bf(
  pa_sub ~ 
    persuasion_self_cw * plan_self + 
    pressure_self_cw * plan_self + 
    pushing_self_cw * plan_self + 

    persuasion_partner_cw * plan_self + 
    pressure_partner_cw * plan_self +
    pushing_partner_cw * plan_self +
    
    persuasion_self_cw * plan_partner + 
    pressure_self_cw * plan_partner + 
    pushing_self_cw * plan_partner + 

    persuasion_partner_cw * plan_partner + 
    pressure_partner_cw * plan_partner +
    pushing_partner_cw * plan_partner +
    ...
    # Random effects
    (1 + persuasion_self_cw * plan_self + 
    pressure_self_cw * plan_self + 
    pushing_self_cw * plan_self + 
      
    persuasion_partner_cw * plan_self + 
    pressure_partner_cw * plan_self +
    pushing_partner_cw * plan_self | dd | coupleID),
  
  hu = ~ persuasion_self_cw * plan_self + 
    pressure_self_cw * plan_self + 
    pushing_self_cw * plan_self + 
...
formula <- bf(
  pa_obj ~ 
    ...
    persuasion_partner_cw * plan_self + 
    pressure_partner_cw * plan_self +
    pushing_partner_cw * plan_self | coupleID)
...
p <- conditional_effects(
  pa_sub, 
  dpar = 'hu',
  effects = 'pushing_self_cw:plan_partner',
  re_formula = NA, 
...
# Test slope significance for both levels. 

```{r}

hypothesis(pa_sub, "-hu_pushing_self_cw > 0")
hypothesis(pa_sub, "-(hu_pushing_self_cw + hu_plan_selfPlan) > 0")
