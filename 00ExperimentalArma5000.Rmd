...
formula <- bf(
  ...
  #, autocor = ~ ma(time = day, gr = coupleID:userID, cov = TRUE)
  , autocor = ~ arma(time = day, gr = coupleID:userID, cov = TRUE)
...
pa_sub <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "pa_sub_hu_arma5000")
)
...
pa_obj_log <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "pa_obj_lognormal_arma5000")
)
...
mood <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "mood_skew_arma5000")
)
...
reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "reactance_hu_arma5000")
  #, file_refit = 'always'
)
...
reactance_ordinal <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "reactance_ordinal_noar_arma5000")
  #, file_refit = 'always'
)
...
is_reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", "is_reactance_noar_arma5000")
  #, file_refit = 'always'
)
