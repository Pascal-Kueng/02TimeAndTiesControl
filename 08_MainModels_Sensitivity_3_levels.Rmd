...
suffix = paste0('_MainModels_3_level', as.character(iterations))
...
model_rows_random <- c(
  ...
  'coupleID:userID: sd(persuasion_self_cw)',
  'coupleID:userID: sd(persuasion_partner_cw)',
  'coupleID:userID: sd(pressure_self_cw)',
  'coupleID:userID: sd(pressure_partner_cw)',
  'coupleID:userID: sd(pushing_self_cw)',
  'coupleID:userID: sd(pushing_partner_cw)',
...
model_rownames_random <- c(
  ...
  # '-- RANDOM EFFECTS L3 --',
  'L2:sd(Intercept)', 
  "L2:sd(Daily individual's experienced persuasion)", 
  "L2:sd(Daily partner's experienced persuasion)", # OR partner received
  "L2:sd(Daily individual's experienced pressure)", 
  "L2:sd(Daily partner's experienced pressure)", 
  "L2:sd(Daily individual's experienced pushing)", 
  "L2:sd(Daily partner's experienced pushing)", 
  # '-- CORRELATION STRUCTURE -- ', 
  'sigma'
)
...
rows_to_pack <- list(
  ...
  "Random Effects (Level 2 - Couple:Person)" = c(26, 32), 
...
rows_to_pack_ordinal <- list(
  ...
  "Random Effects (Level 2 - Couple:Person)" = c(26+5, 32+5), 
...
formula <- bf(
  pa_sub ~ 
    ...
    (1 + persuasion_self_cw + persuasion_partner_cw +
    pressure_self_cw + pressure_partner_cw +
    pushing_self_cw + pushing_partner_cw | d_u | coupleID:userID),
...
```{r check_pa_sub_lognormal_priorsense}
if (do_priorsense) {
  priorsense_vars <- c(
      'Intercept',
...
formula <- bf(
  pa_obj ~ 
    ...
    (persuasion_self_cw + persuasion_partner_cw +
    pressure_self_cw + pressure_partner_cw +
    pushing_self_cw + pushing_partner_cw | coupleID/userID)
...
formula_cens <- bf(
  aff_inv ~ 
    ...
    (persuasion_self_cw + persuasion_partner_cw +
     pressure_self_cw + pressure_partner_cw +
     pushing_self_cw + pushing_partner_cw | c_c | coupleID) + 
    
    (persuasion_self_cw + persuasion_partner_cw +
     pressure_self_cw + pressure_partner_cw +
     pushing_self_cw + pushing_partner_cw | c_u | coupleID:userID),
...
if (check_models) {
  ...
  DHARMa.check_brms.all(mood_cens, integer = FALSE)
}
...
plot(
  bayestestR::p_direction(mood_cens),
  priors = TRUE
)  + 
  coord_cartesian(xlim = c(-3, 3)) +
  theme_bw()
...
plot(
  bayestestR::rope(mood_cens, ci = 1)
) + theme_bw()
