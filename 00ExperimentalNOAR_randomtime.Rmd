...
formula <- bf(
  pa_sub ~ 
    ...
    pressure_self_cw + pressure_partner_cw +
    pushing_self_cw + pushing_partner_cw + day | coupleID),
...
pa_sub <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", paste0("pa_sub_hu_poisson_NOAR_timerandom", suffix))
)
...
pa_sub_zero_model <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", paste0("pa_sub_hu_zero_part_NOAR_timerandom", suffix))
)
...
pa_sub_active_model <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", paste0("pa_sub_hu_active_part_NOAR_timerandom", suffix))
)
...
pa_obj_log <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", paste0("pa_obj_log_gaussian_NOAR_timerandom", suffix))
)
...
mood_gauss <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", paste0("mood_gauss_NOAR_timerandom", suffix))
)
...
reactance_ordinal <- my_brm(
  ...
  cores = 4,
  seed = 7777
  #, file = file.path("models_cache_brms", paste0("reactance_ordinal_NOAR_timerandomNOAR_", suffix))
)
...
is_reactance <- my_brm(
  ...
  cores = 4,
  seed = 7777,
  file = file.path("models_cache_brms", paste0("is_reactance_NOAR_timerandomNOAR_", suffix))
  #, file_refit = 'always'
)
...
export_xlsx(
  ...
  file.path("Output", "AllModels_experimental_NOAR_timerandom.xlsx"), 
  merge_option = 'both', 
